<?php namespace GTO\Framework\Posts {
	...
	abstract class PostType extends \GTO\Framework\Singleton {
		 ...
		 * @return array
		 */
		protected function pre_save_post( array $data, array $postarr ) {
			return $data;
		}
		...
		protected function get_post( \WP_Post $post ) {
			return new \GTO\Framework\Posts\Post( $post );
		}
		 ...
		 * @return array
		 */
		protected function metabox_classes() {
			return array();
		}
	}
}
